...
# Custom imports
from data import Sentinel2Processed, ScaleBatchSampler
...
def main():
    ...
    # Dataset
    train_dataset = Sentinel2Processed(args.dataset, phase='train', transforms=transforms, seed=args.seed)
    ...
    valid_dataset = Sentinel2Processed(args.dataset, phase='valid', seed=args.seed)
